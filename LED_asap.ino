...
void loop() {
  ...
  //     alertMessage += "Bahaya🚨🚨🚨%0A+Gas+smoke+di+laboratorium+melebihi+ambang+batas+segera+tinggalkan+lab+ini+";
  //     for (int i = 0; i < 5; i++) {
  ...
  //     alertMessage += "Waspadalah🚨🚨🚨%0A+Kadar+ozon+di+laboratorium+melebihi+ambang+batas+";
  //     tone(BUZZER_PIN, 1200);
  // }

  // // Kondisi untuk CO2
  // if (co2Value > co2Threshold) {
  //     alertMessage += "Bahaya🚨🚨🚨%0A+Kadar+CO2+di+laboratorium+melebihi+ambang+batas+segera+ambil+tindakan!+";
  //     tone(BUZZER_PIN, 1400);
  // }

  // // Kondisi untuk NO2
  // if (no2Value > no2Threshold) {
  //     alertMessage += "Waspadalah🚨🚨🚨%0A+Kadar+NO2+di+laboratorium+melebihi+ambang+batas+segera+tinggalkan+area+ini+";
  //     tone(BUZZER_PIN, 2000);
  // }
